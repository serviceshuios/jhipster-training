...
import com.huios.blog.service.UrllinkQueryService;
import com.huios.blog.service.UrllinkService;
...
/**
 * REST controller for managing {@link com.huios.blog.domain.Urllink}.
 */
@RestController
@RequestMapping("/api")
public class UrllinkResource {
    ...
    /**
     * {@code SEARCH  /_search/urllinks?query=:query} : search for the urllink corresponding
     * to the query.
     *

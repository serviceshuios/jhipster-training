...
import com.huios.blog.service.CinterestQueryService;
...
/**
 * REST controller for managing {@link com.huios.blog.domain.Cinterest}.
 */
@RestController
@RequestMapping("/api")
public class CinterestResource {
    ...
    /**
     * {@code SEARCH  /_search/cinterests?query=:query} : search for the cinterest corresponding
     * to the query.
     *

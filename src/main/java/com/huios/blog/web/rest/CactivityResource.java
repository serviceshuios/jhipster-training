...
import com.huios.blog.repository.CactivityRepository;
import com.huios.blog.service.CactivityQueryService;
import com.huios.blog.service.CactivityService;
import com.huios.blog.service.criteria.CactivityCriteria;
...
/**
 * REST controller for managing {@link com.huios.blog.domain.Cactivity}.
 */
@RestController
@RequestMapping("/api")
public class CactivityResource {
    ...
    /**
     * {@code SEARCH  /_search/cactivities?query=:query} : search for the cactivity corresponding
     * to the query.
     *

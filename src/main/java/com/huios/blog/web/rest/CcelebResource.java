...
import com.huios.blog.service.CcelebQueryService;
...
/**
 * REST controller for managing {@link com.huios.blog.domain.Cceleb}.
 */
@RestController
@RequestMapping("/api")
public class CcelebResource {
    ...
    /**
     * {@code SEARCH  /_search/ccelebs?query=:query} : search for the cceleb corresponding
     * to the query.
     *

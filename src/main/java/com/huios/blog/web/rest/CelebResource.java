...
import com.huios.blog.service.CelebQueryService;
...
/**
 * REST controller for managing {@link com.huios.blog.domain.Celeb}.
 */
@RestController
@RequestMapping("/api")
public class CelebResource {
    ...
    /**
     * {@code SEARCH  /_search/celebs?query=:query} : search for the celeb corresponding
     * to the query.
     *

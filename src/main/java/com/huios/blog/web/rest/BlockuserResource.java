...
import com.huios.blog.service.BlockuserQueryService;
import com.huios.blog.service.BlockuserService;
...
/**
 * REST controller for managing {@link com.huios.blog.domain.Blockuser}.
 */
@RestController
@RequestMapping("/api")
public class BlockuserResource {
    ...
    /**
     * {@code SEARCH  /_search/blockusers?query=:query} : search for the blockuser corresponding
     * to the query.
     *

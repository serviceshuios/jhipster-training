...
import com.huios.blog.service.ConfigVariablesService;
...
public class ConfigVariablesServiceImpl implements ConfigVariablesService {
    ...
    public Page<ConfigVariablesDTO> search(String query, Pageable pageable) {
        ...
        return configVariablesSearchRepository.search(queryStringQuery(query), pageable).map(configVariablesMapper::toDto);
    }
}

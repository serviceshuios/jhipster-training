...
import com.huios.blog.repository.search.FollowSearchRepository;
import com.huios.blog.service.FollowService;
import com.huios.blog.service.dto.FollowDTO;
import com.huios.blog.service.mapper.FollowMapper;
...
public class FollowServiceImpl implements FollowService {
    ...
    public Page<FollowDTO> search(String query, Pageable pageable) {
        ...
        return followSearchRepository.search(queryStringQuery(query), pageable).map(followMapper::toDto);
    }
}

...
import com.huios.blog.service.criteria.CommentCriteria;
...
class CommentResourceIT {
     ...
     *
     * @see com.huios.blog.repository.search.CommentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.creationDate(UPDATED_CREATION_DATE).isOffensive(UPDATED_IS_OFFENSIVE);

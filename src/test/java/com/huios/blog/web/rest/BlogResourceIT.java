...
import com.huios.blog.repository.search.BlogSearchRepository;
import com.huios.blog.service.criteria.BlogCriteria;
import com.huios.blog.service.dto.BlogDTO;
import com.huios.blog.service.mapper.BlogMapper;
...
class BlogResourceIT {
     ...
     *
     * @see com.huios.blog.repository.search.BlogSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void partialUpdateBlogWithPatch() throws Exception {
        ...
        partialUpdatedBlog.creationDate(UPDATED_CREATION_DATE);

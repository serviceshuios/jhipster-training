...
import com.huios.blog.domain.Tag;
import com.huios.blog.domain.Topic;
import com.huios.blog.repository.PostRepository;
import com.huios.blog.repository.search.PostSearchRepository;
import com.huios.blog.service.criteria.PostCriteria;
import com.huios.blog.service.dto.PostDTO;
import com.huios.blog.service.mapper.PostMapper;
...
class PostResourceIT {
     ...
     *
     * @see com.huios.blog.repository.search.PostSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.leadtext(UPDATED_LEADTEXT).quote(UPDATED_QUOTE).conclusion(UPDATED_CONCLUSION).linkText(UPDATED_LINK_TEXT);

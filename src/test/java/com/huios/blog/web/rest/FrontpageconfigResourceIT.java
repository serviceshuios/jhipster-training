...
import com.huios.blog.repository.search.FrontpageconfigSearchRepository;
import com.huios.blog.service.criteria.FrontpageconfigCriteria;
import com.huios.blog.service.dto.FrontpageconfigDTO;
import com.huios.blog.service.mapper.FrontpageconfigMapper;
...
class FrontpageconfigResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/frontpageconfigs";
     ...
     *
     * @see com.huios.blog.repository.search.FrontpageconfigSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void putNewFrontpageconfig() throws Exception {
        ...
        // Validate the Frontpageconfig in Elasticsearch
        verify(mockFrontpageconfigSearchRepository).save(testFrontpageconfig);
    }
    ...
    @Test
    @Transactional
    void searchFrontpageconfig() throws Exception {
        ...
        restFrontpageconfigMockMvc
            .perform(get(ENTITY_SEARCH_API_URL + "?query=id:" + frontpageconfig.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(frontpageconfig.getId().intValue())))
            .andExpect(jsonPath("$.[*].creationDate").value(hasItem(DEFAULT_CREATION_DATE.toString())))

...
class AppphotoResourceIT {
     ...
     *
     * @see com.huios.blog.repository.search.AppphotoSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchAppphoto() throws Exception {
        ...
        // Initialize the database
        appphotoRepository.saveAndFlush(appphoto);
        when(mockAppphotoSearchRepository.search(queryStringQuery("id:" + appphoto.getId()), PageRequest.of(0, 20)))

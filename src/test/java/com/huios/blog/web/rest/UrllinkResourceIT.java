...
import com.huios.blog.repository.UrllinkRepository;
import com.huios.blog.repository.search.UrllinkSearchRepository;
import com.huios.blog.service.criteria.UrllinkCriteria;
import com.huios.blog.service.dto.UrllinkDTO;
import com.huios.blog.service.mapper.UrllinkMapper;
...
class UrllinkResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/urllinks";
     ...
     *
     * @see com.huios.blog.repository.search.UrllinkSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void putNewUrllink() throws Exception {
        ...
        // Validate the Urllink in Elasticsearch
        verify(mockUrllinkSearchRepository).save(testUrllink);
    }
    ...
    @Test
    @Transactional
    void searchUrllink() throws Exception {
        ...
        // Search the urllink
        restUrllinkMockMvc
            .perform(get(ENTITY_SEARCH_API_URL + "?query=id:" + urllink.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(urllink.getId().intValue())))
            .andExpect(jsonPath("$.[*].linkText").value(hasItem(DEFAULT_LINK_TEXT)))

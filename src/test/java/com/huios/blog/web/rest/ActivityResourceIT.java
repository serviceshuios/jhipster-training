...
import com.huios.blog.repository.ActivityRepository;
import com.huios.blog.repository.search.ActivitySearchRepository;
import com.huios.blog.service.ActivityService;
import com.huios.blog.service.criteria.ActivityCriteria;
import com.huios.blog.service.dto.ActivityDTO;
import com.huios.blog.service.mapper.ActivityMapper;
...
class ActivityResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/activities";
     ...
     *
     * @see com.huios.blog.repository.search.ActivitySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void putNewActivity() throws Exception {
        ...
        // Validate the Activity in Elasticsearch
        verify(mockActivitySearchRepository).save(testActivity);
    }

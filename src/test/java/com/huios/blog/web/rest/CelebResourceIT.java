...
import com.huios.blog.repository.CelebRepository;
import com.huios.blog.repository.search.CelebSearchRepository;
import com.huios.blog.service.CelebService;
import com.huios.blog.service.criteria.CelebCriteria;
import com.huios.blog.service.dto.CelebDTO;
import com.huios.blog.service.mapper.CelebMapper;
...
class CelebResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/celebs";
     ...
     *
     * @see com.huios.blog.repository.search.CelebSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void putNewCeleb() throws Exception {
        ...
        // Validate the Celeb in Elasticsearch
        verify(mockCelebSearchRepository).save(testCeleb);
    }
    ...
    @Test
    @Transactional
    void searchCeleb() throws Exception {
        ...
        // Search the celeb
        restCelebMockMvc
            .perform(get(ENTITY_SEARCH_API_URL + "?query=id:" + celeb.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(celeb.getId().intValue())))
            .andExpect(jsonPath("$.[*].celebName").value(hasItem(DEFAULT_CELEB_NAME)));

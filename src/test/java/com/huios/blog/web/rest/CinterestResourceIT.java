...
import com.huios.blog.repository.CinterestRepository;
import com.huios.blog.repository.search.CinterestSearchRepository;
import com.huios.blog.service.CinterestService;
import com.huios.blog.service.criteria.CinterestCriteria;
import com.huios.blog.service.dto.CinterestDTO;
import com.huios.blog.service.mapper.CinterestMapper;
...
class CinterestResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/cinterests";
     ...
     *
     * @see com.huios.blog.repository.search.CinterestSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void putNewCinterest() throws Exception {
        ...
        // Validate the Cinterest in Elasticsearch
        verify(mockCinterestSearchRepository).save(testCinterest);
    }
    ...
    @Test
    @Transactional
    void searchCinterest() throws Exception {
        ...
        restCinterestMockMvc
            .perform(get(ENTITY_SEARCH_API_URL + "?query=id:" + cinterest.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(cinterest.getId().intValue())))
            .andExpect(jsonPath("$.[*].interestName").value(hasItem(DEFAULT_INTEREST_NAME)));
